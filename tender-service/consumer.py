...
def main():
    ...
    channel.queue_declare(queue='hub_changed_tender')
    channel.queue_bind(exchange='hub_changed', queue='hub_changed_tender')

    channel.basic_consume(queue='hub_changed_tender', on_message_callback=callback_hub_changed)
