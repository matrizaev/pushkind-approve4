...
def main():
    ...
    channel.queue_declare(queue='hub_removed_tender')
    channel.queue_bind(exchange='hub_removed', queue='hub_removed_tender')
    ...
    channel.basic_consume(queue='hub_removed_tender', on_message_callback=callback)
