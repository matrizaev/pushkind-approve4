...
def main():
    ...
    channel.queue_declare(queue='hub_removed_user')
    channel.queue_bind(exchange='hub_removed', queue='hub_removed_user')
    ...
    channel.basic_consume(queue='hub_removed_user', on_message_callback=callback)
