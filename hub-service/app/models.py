...
class Product(db.Model):
    ...
    def to_dict(self):
        data = {
            "id": self.id,
            "vendor": {"name": self.vendor.name, "email": self.vendor.email},
            "name": self.name,
            "sku": self.sku,
            "price": self.price,
            "image": self.image,
            ...
            "category": {"name": self.category.name, "code": self.category.code},
        }
        return data
...
class AppSettings(db.Model):
    ...
    def from_dict(self, data):
        ...
        self.alert = alert.strip() if alert else None
        for key, value in data.items():
            setattr(self, key, value)
