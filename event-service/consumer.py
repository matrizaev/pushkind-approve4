...
def main():
    ...
    channel.queue_declare(queue='hub_changed_event')
    channel.queue_bind(exchange='hub_changed', queue='hub_changed_event')

    channel.basic_consume(queue='hub_changed_event', on_message_callback=callback_hub_changed)
