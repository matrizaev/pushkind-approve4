...
def main():
    ...
    channel.queue_declare(queue='hub_removed_order')
    channel.queue_bind(exchange='hub_removed', queue='hub_removed_order')
    ...
    channel.basic_consume(queue='hub_removed_order', on_message_callback=callback)
